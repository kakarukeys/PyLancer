...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Job.contract_type'
        db.add_column('job_board_job', 'contract_type',
                      self.gf('django.db.models.fields.CharField')(default='FL', max_length=2),
                      keep_default=False)

        # Adding field 'Job.location'
        db.add_column('job_board_job', 'location',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=40),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Job.contract_type'
        db.delete_column('job_board_job', 'contract_type')

        # Deleting field 'Job.location'
        db.delete_column('job_board_job', 'location')
    ...
    models = {
        ...
        'job_board.job': {
            ...
            'contract_type': ('django.db.models.fields.CharField', [], {'max_length': '2'}),
